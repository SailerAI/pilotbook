---
description: Break a Pilotbook epic into independently shippable user stories. Use after an idea is promoted to an epic, when the user asks to slice, split into stories, write user stories, or after discover finishes. Do not use to break stories into engineering tasks — that is architect. Do not use pb split on a freshly promoted epic.
---
