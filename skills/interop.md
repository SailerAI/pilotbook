...
commands: [pb profile, pb sync, pb export, pb seed, pb manifest, pb graph, pb lint]
writes: [docs/**/*.md, .pb/graph.json]
done: The requested transfer completed (or its dry-run plan was shown and confirmed) and pb lint is clean afterward.
---
